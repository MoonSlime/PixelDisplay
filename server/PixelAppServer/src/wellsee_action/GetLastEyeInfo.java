package wellsee_action;

import connect.Database;
import model.ResponseModel;
import model.UserModel;
import wellsee_model_handler.EyeHandler;
...
public class GetLastEyeInfo extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (userModel == null) {
            ...
            try {
                ...
                ResponseModel result = new EyeHandler(db).getLastEyeInfo(userModel);
